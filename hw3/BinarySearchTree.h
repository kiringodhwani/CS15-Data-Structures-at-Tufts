...
private:
        ...
        // Returns the Node with the given value in the BST
        Node *get(Node *node, int value) const;
        
        // Handles the case when remove is called on a leaf Node
        void remove_leaf(Node *node, Node *parent);
        
        // Handles the case when remove is called on a Node with only a right
        // child
        void remove_one_child_right(Node *node, Node *parent);
        
        // Handles the case when remove is called on a Node with only a left
        // child
        void remove_one_child_left(Node *node, Node *parent);
};
