...
class CharArrayList {
    public:
        ...
        // function to test the shrink() function, will be commented out
        // before submission
        // int return_cap() const;
    ...
    private:
        ...
        * list, and the current size of the array in memory */
        ...
        // global constant for the initial capacity of the array list
        const static int INITIAL_CAPACITY = 10;

        // Increases the capacity of the array list by a reasonable factor 
        // each time the array list reaches its capacity
        void expand();
        
        // Shrinks the array list when it falls below 1/4 capacity
        void shrink();
